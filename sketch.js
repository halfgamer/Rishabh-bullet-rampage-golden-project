...
function draw()
{
      ...
      text("This is your attepmt "+gc,displayWidth/2+400,displayHeight/3-50)
      }
}
...
function spawnheli()
{
    ...
    heli.lives=3;
    heli.debug=true
    heli.setCollider("rectangle",0,0,100,100)
...
function gameMain()
{
    ...
    if (keyWentUp("space")&&flag===1)
    {
      ...
      bullet.setSpeedAndDirection(20, angle);
